...
public class Window extends JApplet {
	...
	public static class outline {
		...
		public static void circle(int x, int y, int radius) {
			if (! initialized) Window.size(defaultWidth, defaultHeight);
			Window.getInstanceFromThread().drawOval(x - radius, y - radius, radius * 2, radius * 2);
		}
		...
		public static void circle(double x, double y, double radius) {
			if (! initialized) Window.size(defaultWidth, defaultHeight);
			Window.getInstanceFromThread().drawOval((int) (x - radius), (int) (y - radius), (int) (radius * 2), (int) (radius * 2));
		}
		...
		public static void rectangle(int x, int y, int width, int height) {
			if (! initialized) Window.size(defaultWidth, defaultHeight);
			Window.getInstanceFromThread().drawRect(x - width / 2, y - height / 2, width, height);
		}
		...
		public static void rectangle(int x, int y, int width, int height, double angle) {
			...
			Window.outline.polygon(x + rotatedX(- width / 2, - height / 2, angle), y + rotatedY(-width / 2, -height / 2, angle),
					x + rotatedX(-width / 2, height / 2, angle), y + rotatedY(-width / 2, height / 2, angle),
					x + rotatedX(width / 2, height / 2, angle), y + rotatedY(width / 2, height / 2, angle),
					x + rotatedX(width / 2, -height / 2, angle), y + rotatedY(width / 2, -height / 2, angle));
		}
		...
		public static void square(int x, int y, int side) {
			if (! initialized) Window.size(defaultWidth, defaultHeight);
			Window.getInstanceFromThread().drawRect(x - side / 2, y - side / 2, side, side);
		}
		...
		public static void oval(int x, int y, int width, int height) {
			if (! initialized) Window.size(defaultWidth, defaultHeight);
			Window.getInstanceFromThread().drawOval(x - width / 2, y - height / 2, width, height);
		}
		...
		public static void polygon(int[] x, int[] y) {
			if (! initialized) Window.size(defaultWidth, defaultHeight);
			Window.getInstanceFromThread().drawPolygon(x, y);
		}
